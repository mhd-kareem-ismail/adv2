export const navLinks = [
  ...
  { id: 3, label: 'Academics', href: '#' },
  { id: 4, label: 'Admissions', href: '#' },
  { id: 5, label: 'Student Life', href: '#' },
  { id: 6, label: 'Contact', href: '#', isButton: true }
];

export const heroStats = [
  { id: 1, number: '+7000', label: 'Students Passed Out' },
  { id: 2, number: '+37', label: 'Awards & Recognitions' },
  { id: 3, number: '+15', label: 'Experience Educators' }
];
...
export const benefits = [
  ...
  },
  {
    ...
    description: 'Our comprehensive arts program encourages self-expression through music, painting, and creative activities.'
  },
  {
    id: 8,
    icon: '🏃',
    title: 'Physical Development',
    description: 'Regular physical activities and outdoor play promote healthy growth and motor skill development.'
  },
  {
    id: 9,
    icon: '📚',
    title: 'Early Literacy Focus',
    description: 'We emphasize reading readiness and language development through engaging storytelling and phonics programs.'
  }
];
...
export const faqs = [
  ...
  },
  {
    ...
    answer: 'Yes, we have a comfortable uniform policy that promotes equality and school spirit.',
    isExpanded: false
  },
  {
    id: 3,
    question: 'What extracurricular activities are available for students?',
    answer: 'We offer various activities including arts, music, sports, and educational clubs.',
    isExpanded: false
  },
  {
    id: 4,
    question: 'How do you handle food allergies and dietary restrictions?',
    answer: 'We work closely with parents to accommodate all dietary needs and allergies safely.',
    isExpanded: false
  },
  {
    id: 5,
    question: 'What is the teacher-to-student ratio at Little Learners Academy?',
    answer: 'We maintain a low ratio of 1:8 to ensure personalized attention for each child.',
    isExpanded: false
  },
  {
    id: 6,
    question: 'How do you handle discipline and behavior management?',
    answer: 'We use positive reinforcement and age-appropriate guidance techniques.',
    isExpanded: false
  },
  {
    id: 7,
    question: 'How do I apply for admission to Little Learners Academy?',
    answer: 'You can apply through our online portal or visit our admissions office for assistance.',
    isExpanded: false
  }
];
...
export const footerLinks = {
  ...
  academics: [
    { label: 'Special Features', href: '#' },
    { label: 'Gallery', href: '#' }
  ],
  contact: [
    { label: 'Information', href: '#' },
    { label: 'Map & Direction', href: '#' }
  ]
};